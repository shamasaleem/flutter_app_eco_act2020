            ...
            Positioned(
              ...
              child: Container(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.center,
                  children: [
                    Center(
                      child: Text ('Choose your feed... Select all that apply', style: TextStyle(fontSize: 30, fontWeight: FontWeight.w600,fontFamily: 'DMSerifDisplay',)
                      ),
                    ),
                    SizedBox(
                      height: 200,
                      ...
                      children: [
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            height: 100,
                            child:Center(
                              child: Text ('Lifestyle', style: TextStyle(fontSize: 20, fontWeight: FontWeight.w600,fontFamily: 'DMSerifDisplay',)
                              ),
                            ),
                          ),
                        )],
                      ...
                      children: [
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            height: 100,
                            child:Center(
                              child: Text ('Activism', style: TextStyle(fontSize: 20, fontWeight: FontWeight.w600,fontFamily: 'DMSerifDisplay',)
                              ),
                            ),
                          ),
                        ),
                        ...
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            height: 100,
                            child:Center(
                              child: Text ('News', style: TextStyle(fontSize: 20, fontWeight: FontWeight.w600,fontFamily: 'DMSerifDisplay',)
                              ),
                            ),
                          ),
                        ),
                      ...
                      children: [
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            height: 100,
                            child:Center(
                              child: Text ('Science', style: TextStyle(fontSize: 20, fontWeight: FontWeight.w600,fontFamily: 'DMSerifDisplay',)
                              ),
                            ),
                          ),
                        ),
                        ...
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            height: 100,
                            child:Center(
                              child: Text ('Public Figures', style: TextStyle(fontSize: 20, fontWeight: FontWeight.w600,fontFamily: 'DMSerifDisplay',)
                              ),
                            ),
                          ),
                        ),
