...
class _EventsState extends State<Events> {
  ...
  List locations = ['San Francisco', 'San Jose', 'San Ramon', 'Fremont'];
              ...
              child: Container(
                ...
                child: Column(
                  children: <Widget>[
                      ...
                      value: value,
                      child: Text(value, style: TextStyle(fontSize: 23.0, color: Colors.teal.withOpacity(0.75),fontFamily: 'DMSerifDisplay',
                              ),
                            ),
                          );
                        }).toList(),
